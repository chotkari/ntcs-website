...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Seamless integration of Cloud infrastructure and applications for optimal performance.",
      features: [
        "AWS/Azure/GCP",
        "Migration services",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-4">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 relative">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Comprehensive technology solutions that drive{" "}
        ...
        <div
          className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 md:gap-4 xl:gap-8"
          id="service"
        >
