          ...
          <div className="max-w-8xl mx-auto">
            ...
            <div className="text-center mb-14">
              ...
              <div className="flex justify-center">
                <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                  Our skilled and dedicated professionals bring expertise across development, support, design, testing,
                  and consulting.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
              {team.map((member, index) => (
                ...
                >
                  <div
                    className="mb-5 w-40 h-40 rounded-full overflow-hidden border-2 border-white shadow-md bg-gradient-to-br from-primary-200 to-accent-200">
                    <img
                      src={member.image}
